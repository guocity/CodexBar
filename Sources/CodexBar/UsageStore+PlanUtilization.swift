...
extension UsageStore {
        ...
        async
    {
        ...
        await MainActor.run {
            ...
            // Always capture the account key for telemetry, even when history did not
            // change. Flat usage refreshes previously returned here and skipped the
            // self-hosted telemetry pipeline entirely.
        ...
        // Intentionally not gated on history mutation — transport should see every refresh sample.
